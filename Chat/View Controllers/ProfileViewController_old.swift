//
//  ProfileViewController_old.swift
//  Chat
//
...
class ProfileViewController_old: UIViewController, UINavigationControllerDelegate {
    ...
    required init?(coder: NSCoder) {
        ...
        // На момент инициализации ProfileViewController_old — editButton еще не инициализирована, поэтому не известен и frame кнопки
    }
...
extension ProfileViewController_old: UIImagePickerControllerDelegate {
